// $ANTLR 3.4 EventFilter.g 2012-08-22 11:55:58
...
public class EventFilterParser extends Parser {
    ...
    public EventFilterParser(TokenStream input) {
        this(input, new RecognizerSharedState());
    }
    public EventFilterParser(TokenStream input, RecognizerSharedState state) {
        super(input, state);
    }
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String[] getTokenNames() { return EventFilterParser.tokenNames; }
    public String getGrammarFileName() { return "EventFilter.g"; }


    	/**
    		Creates a new parser that parses the given input string.
    	*/
    	public static EventFilterParser createParser(String input) {
    	    ANTLRStringStream inputStream = new ANTLRStringStream(input);
    		EventFilterLexer lexer = new EventFilterLexer(inputStream);
    		CommonTokenStream tokens = new CommonTokenStream(lexer); 
    		
    		return new EventFilterParser(tokens);
        }
    	...
    	private void throwParsingError(String[] tokenNames, RecognitionException e) {
    		...
    		throw new EventFilterParsingException(String.format("%s %s", hdr, msg), e);
    	}
    ...
    // $ANTLR start "filter"
    // EventFilter.g:102:1: filter : (a= boolean_expr -> $a) ( OR b= boolean_expr -> ^( OR $filter $b) )* ( EOF )? ;
    public final EventFilterParser.filter_return filter() throws RecognitionException {
        EventFilterParser.filter_return retval = new EventFilterParser.filter_return();
        ...
        Token OR1=null;
        Token EOF2=null;
        EventFilterParser.boolean_expr_return a =null;

        EventFilterParser.boolean_expr_return b =null;
        ...
        try {
            // EventFilter.g:103:2: ( (a= boolean_expr -> $a) ( OR b= boolean_expr -> ^( OR $filter $b) )* ( EOF )? )
            // EventFilter.g:103:4: (a= boolean_expr -> $a) ( OR b= boolean_expr -> ^( OR $filter $b) )* ( EOF )?
            {
            // EventFilter.g:103:4: (a= boolean_expr -> $a)
            // EventFilter.g:103:5: a= boolean_expr
            {
            ...
            // EventFilter.g:103:25: ( OR b= boolean_expr -> ^( OR $filter $b) )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // EventFilter.g:103:26: OR b= boolean_expr
            	    {
            	    ...
            	    // 103:44: -> ^( OR $filter $b)
            	    {
            	        // EventFilter.g:103:47: ^( OR $filter $b)
            	        {
    ...
    // EventFilter.g:106:1: boolean_expr : (a= boolean_factor -> $a) ( AND b= boolean_factor -> ^( AND $boolean_expr $b) )* ;
    public final EventFilterParser.boolean_expr_return boolean_expr() throws RecognitionException {
        EventFilterParser.boolean_expr_return retval = new EventFilterParser.boolean_expr_return();
        retval.start = input.LT(1);
        ...
        Token AND3=null;
        EventFilterParser.boolean_factor_return a =null;

        EventFilterParser.boolean_factor_return b =null;
        ...
        try {
            // EventFilter.g:107:2: ( (a= boolean_factor -> $a) ( AND b= boolean_factor -> ^( AND $boolean_expr $b) )* )
            // EventFilter.g:107:4: (a= boolean_factor -> $a) ( AND b= boolean_factor -> ^( AND $boolean_expr $b) )*
            {
            // EventFilter.g:107:4: (a= boolean_factor -> $a)
            // EventFilter.g:107:5: a= boolean_factor
            {
            ...
            // EventFilter.g:107:27: ( AND b= boolean_factor -> ^( AND $boolean_expr $b) )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // EventFilter.g:107:28: AND b= boolean_factor
            	    {
            	    ...
            	    {
            	        // EventFilter.g:107:52: ^( AND $boolean_expr $b)
            	        {
            	        CommonTree root_1 = (CommonTree)adaptor.nil();
            	        root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:111:1: boolean_factor : ( predicate | NOT predicate -> ^( NOT predicate ) );
    public final EventFilterParser.boolean_factor_return boolean_factor() throws RecognitionException {
        EventFilterParser.boolean_factor_return retval = new EventFilterParser.boolean_factor_return();
        retval.start = input.LT(1);
        ...
        Token NOT5=null;
        EventFilterParser.predicate_return predicate4 =null;

        EventFilterParser.predicate_return predicate6 =null;
        ...
        try {
            // EventFilter.g:112:2: ( predicate | NOT predicate -> ^( NOT predicate ) )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // EventFilter.g:113:6: NOT predicate
                    {
                    ...
                    {
                        // EventFilter.g:113:23: ^( NOT predicate )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:116:1: predicate : ( '(' filter ')' -> filter | comparison_function | between_predicate | in_predicate | null_predicate | regex_predicate | exists_predicate | TRUE -> TRUE | FALSE -> FALSE );
    public final EventFilterParser.predicate_return predicate() throws RecognitionException {
        EventFilterParser.predicate_return retval = new EventFilterParser.predicate_return();
        retval.start = input.LT(1);
        ...
        Token TRUE16=null;
        Token FALSE17=null;
        EventFilterParser.filter_return filter8 =null;

        EventFilterParser.comparison_function_return comparison_function10 =null;

        EventFilterParser.between_predicate_return between_predicate11 =null;

        EventFilterParser.in_predicate_return in_predicate12 =null;

        EventFilterParser.null_predicate_return null_predicate13 =null;

        EventFilterParser.regex_predicate_return regex_predicate14 =null;

        EventFilterParser.exists_predicate_return exists_predicate15 =null;
        ...
        try {
            // EventFilter.g:117:2: ( '(' filter ')' -> filter | comparison_function | between_predicate | in_predicate | null_predicate | regex_predicate | exists_predicate | TRUE -> TRUE | FALSE -> FALSE )
            int alt5=9;
            switch ( input.LA(1) ) {
            case 33:
                {
            ...
            switch (alt5) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // EventFilter.g:118:3: comparison_function
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // EventFilter.g:119:3: between_predicate
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // EventFilter.g:120:3: in_predicate
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // EventFilter.g:121:3: null_predicate
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 6 :
                    // EventFilter.g:122:3: regex_predicate
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 7 :
                    // EventFilter.g:123:3: exists_predicate
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    public final EventFilterParser.comparison_function_return comparison_function() throws RecognitionException {
        EventFilterParser.comparison_function_return retval = new EventFilterParser.comparison_function_return();
        retval.start = input.LT(1);
        ...
        Token LT31=null;
        Token LE34=null;
        EventFilterParser.path_function_return path_function18 =null;

        EventFilterParser.value_function_return value_function20 =null;

        EventFilterParser.path_function_return path_function21 =null;

        EventFilterParser.value_function_return value_function23 =null;

        EventFilterParser.path_function_return path_function24 =null;

        EventFilterParser.compariable_value_function_return compariable_value_function26 =null;

        EventFilterParser.path_function_return path_function27 =null;

        EventFilterParser.compariable_value_function_return compariable_value_function29 =null;

        EventFilterParser.path_function_return path_function30 =null;

        EventFilterParser.compariable_value_function_return compariable_value_function32 =null;

        EventFilterParser.path_function_return path_function33 =null;

        EventFilterParser.compariable_value_function_return compariable_value_function35 =null;
        ...
        try {
            // EventFilter.g:129:2: ( path_function EQUALS value_function -> ^( EQUALS path_function value_function ) | path_function NOT_EQUALS value_function -> ^( NOT_EQUALS path_function value_function ) | path_function GT compariable_value_function -> ^( GT path_function compariable_value_function ) | path_function GE compariable_value_function -> ^( GE path_function compariable_value_function ) | path_function LT compariable_value_function -> ^( LT path_function compariable_value_function ) | path_function LE compariable_value_function -> ^( LE path_function compariable_value_function ) )
            int alt6=6;
            ...
            switch (alt6) {
                case 1 :
                    // EventFilter.g:129:4: path_function EQUALS value_function
                    {
                    ...
                    {
                        // EventFilter.g:129:43: ^( EQUALS path_function value_function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                    ...
                    break;
                case 2 :
                    // EventFilter.g:130:3: path_function NOT_EQUALS value_function
                    {
                    ...
                    {
                        // EventFilter.g:130:46: ^( NOT_EQUALS path_function value_function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                    ...
                    break;
                case 3 :
                    // EventFilter.g:131:3: path_function GT compariable_value_function
                    {
                    ...
                    {
                        // EventFilter.g:131:50: ^( GT path_function compariable_value_function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                    ...
                    break;
                case 4 :
                    // EventFilter.g:132:3: path_function GE compariable_value_function
                    {
                    ...
                    {
                        // EventFilter.g:132:50: ^( GE path_function compariable_value_function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                    ...
                    break;
                case 5 :
                    // EventFilter.g:133:3: path_function LT compariable_value_function
                    {
                    ...
                    {
                        // EventFilter.g:133:50: ^( LT path_function compariable_value_function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                    ...
                    break;
                case 6 :
                    // EventFilter.g:134:3: path_function LE compariable_value_function
                    {
                    ...
                    {
                        // EventFilter.g:134:50: ^( LE path_function compariable_value_function )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    public final EventFilterParser.in_predicate_return in_predicate() throws RecognitionException {
        EventFilterParser.in_predicate_return retval = new EventFilterParser.in_predicate_return();
        retval.start = input.LT(1);
        ...
        EventFilterParser.path_function_return path_function57 =null;

        EventFilterParser.path_function_return path_function64 =null;
        ...
        RewriteRuleSubtreeStream stream_path_function=new RewriteRuleSubtreeStream(adaptor,"rule path_function");
        try {
            // EventFilter.g:147:2: ( path_function IN '(' STRING ( ',' STRING )* ')' -> ^( IN path_function ( STRING )+ ) | path_function IN '(' NUMBER ( ',' NUMBER )* ')' -> ^( IN path_function ( NUMBER )+ ) )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // EventFilter.g:147:4: path_function IN '(' STRING ( ',' STRING )* ')'
                    {
                    ...
                    {
                        // EventFilter.g:147:53: ^( IN path_function ( STRING )+ )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                    ...
                    break;
                case 2 :
                    // EventFilter.g:148:3: path_function IN '(' NUMBER ( ',' NUMBER )* ')'
                    {
                    ...
                    {
                        // EventFilter.g:148:52: ^( IN path_function ( NUMBER )+ )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:151:1: null_predicate : path_function IS NULL -> ^( NULL path_function ) ;
    public final EventFilterParser.null_predicate_return null_predicate() throws RecognitionException {
        EventFilterParser.null_predicate_return retval = new EventFilterParser.null_predicate_return();
        retval.start = input.LT(1);
        ...
        Token IS72=null;
        Token NULL73=null;
        EventFilterParser.path_function_return path_function71 =null;
        ...
        RewriteRuleSubtreeStream stream_path_function=new RewriteRuleSubtreeStream(adaptor,"rule path_function");
        try {
            // EventFilter.g:152:2: ( path_function IS NULL -> ^( NULL path_function ) )
            // EventFilter.g:152:4: path_function IS NULL
            {
            ...
            {
                // EventFilter.g:152:29: ^( NULL path_function )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:155:1: regex_predicate : path_function MATCHES STRING -> ^( MATCHES path_function STRING ) ;
    public final EventFilterParser.regex_predicate_return regex_predicate() throws RecognitionException {
        EventFilterParser.regex_predicate_return retval = new EventFilterParser.regex_predicate_return();
        retval.start = input.LT(1);
        ...
        Token STRING76=null;
        EventFilterParser.path_function_return path_function74 =null;
        ...
        RewriteRuleSubtreeStream stream_path_function=new RewriteRuleSubtreeStream(adaptor,"rule path_function");
        try {
            // EventFilter.g:156:2: ( path_function MATCHES STRING -> ^( MATCHES path_function STRING ) )
            // EventFilter.g:156:6: path_function MATCHES STRING
            {
            ...
            {
                // EventFilter.g:156:38: ^( MATCHES path_function STRING )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:159:1: exists_predicate : ( path_function EXISTS -> ^( EXISTS path_function ) | EXISTS path_function -> ^( EXISTS path_function ) );
    ...
    // EventFilter.g:164:1: path_function : XPATH_FUN_NAME '(' STRING ')' -> ^( XPATH_FUN_NAME STRING ) ;
    public final EventFilterParser.path_function_return path_function() throws RecognitionException {
        EventFilterParser.path_function_return retval = new EventFilterParser.path_function_return();
        retval.start = input.LT(1);
        ...
        try {
            // EventFilter.g:165:2: ( XPATH_FUN_NAME '(' STRING ')' -> ^( XPATH_FUN_NAME STRING ) )
            // EventFilter.g:165:4: XPATH_FUN_NAME '(' STRING ')'
            {
            ...
            {
                // EventFilter.g:165:37: ^( XPATH_FUN_NAME STRING )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:168:1: value_function : ( equality_value_function | compariable_value_function );
    public final EventFilterParser.value_function_return value_function() throws RecognitionException {
        EventFilterParser.value_function_return retval = new EventFilterParser.value_function_return();
        retval.start = input.LT(1);


        CommonTree root_0 = null;

        EventFilterParser.equality_value_function_return equality_value_function85 =null;

        EventFilterParser.compariable_value_function_return compariable_value_function86 =null;



        try {
            // EventFilter.g:169:2: ( equality_value_function | compariable_value_function )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // EventFilter.g:169:4: equality_value_function
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // EventFilter.g:169:30: compariable_value_function
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // EventFilter.g:172:1: equality_value_function : ( STRING -> STRING | TRUE -> TRUE | FALSE -> FALSE | NULL -> NULL | path_function );
    public final EventFilterParser.equality_value_function_return equality_value_function() throws RecognitionException {
        EventFilterParser.equality_value_function_return retval = new EventFilterParser.equality_value_function_return();
        retval.start = input.LT(1);
        ...
        Token FALSE89=null;
        Token NULL90=null;
        EventFilterParser.path_function_return path_function91 =null;
        ...
        try {
            // EventFilter.g:173:2: ( STRING -> STRING | TRUE -> TRUE | FALSE -> FALSE | NULL -> NULL | path_function )
            int alt13=5;
            switch ( input.LA(1) ) {
            case STRING:
                {
            ...
            switch (alt13) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // EventFilter.g:177:3: path_function
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // EventFilter.g:180:1: compariable_value_function : ( NUMBER -> NUMBER | time_millis_function | time_string_function );
    public final EventFilterParser.compariable_value_function_return compariable_value_function() throws RecognitionException {
        EventFilterParser.compariable_value_function_return retval = new EventFilterParser.compariable_value_function_return();
        retval.start = input.LT(1);
        ...
        Token NUMBER92=null;
        EventFilterParser.time_millis_function_return time_millis_function93 =null;

        EventFilterParser.time_string_function_return time_string_function94 =null;
        ...
        try {
            // EventFilter.g:181:2: ( NUMBER -> NUMBER | time_millis_function | time_string_function )
            int alt14=3;
            switch ( input.LA(1) ) {
            case NUMBER:
                {
            ...
            switch (alt14) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // EventFilter.g:182:3: time_millis_function
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // EventFilter.g:183:3: time_string_function
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // EventFilter.g:186:1: time_millis_function : ( TIME_MILLIS_FUN_NAME '(' STRING ',' STRING ')' -> ^( TIME_MILLIS_FUN_NAME STRING STRING ) |);
    public final EventFilterParser.time_millis_function_return time_millis_function() throws RecognitionException {
        EventFilterParser.time_millis_function_return retval = new EventFilterParser.time_millis_function_return();
        retval.start = input.LT(1);
        ...
        try {
            // EventFilter.g:187:2: ( TIME_MILLIS_FUN_NAME '(' STRING ',' STRING ')' -> ^( TIME_MILLIS_FUN_NAME STRING STRING ) |)
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // EventFilter.g:187:4: TIME_MILLIS_FUN_NAME '(' STRING ',' STRING ')'
                    {
                    ...
                    {
                        // EventFilter.g:187:54: ^( TIME_MILLIS_FUN_NAME STRING STRING )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // EventFilter.g:193:1: time_string_function : TIME_STRING_FUN_NAME '(' STRING ',' STRING ',' STRING ')' -> ^( TIME_STRING_FUN_NAME STRING STRING STRING ) ;
    public final EventFilterParser.time_string_function_return time_string_function() throws RecognitionException {
        EventFilterParser.time_string_function_return retval = new EventFilterParser.time_string_function_return();
        retval.start = input.LT(1);
        ...
        try {
            // EventFilter.g:194:2: ( TIME_STRING_FUN_NAME '(' STRING ',' STRING ',' STRING ')' -> ^( TIME_STRING_FUN_NAME STRING STRING STRING ) )
            // EventFilter.g:194:5: TIME_STRING_FUN_NAME '(' STRING ',' STRING ',' STRING ')'
            {
            ...
            {
                // EventFilter.g:194:66: ^( TIME_STRING_FUN_NAME STRING STRING STRING )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
